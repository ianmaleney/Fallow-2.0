  ...
  <body>
    <div class="primary-container info-page-container">
      ...
      <section class="info-section">
        ...
        <p>We use Paypal to handle donations and subscription payments. If you have any trouble, <a href="mailto:info@fallowmedia.com">email us</a> and we'll sort you out.</p>
        <div id="subform">
