<footer>
  <div class="footer-container">
    ...
    <div class="social">
      ...
      <a href="https://github.com/ianmaleney/Fallow-2.0" target="_blank">
      ...
      <a href="https://fallowmedia.bandcamp.com/" target="_blank">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 67 67">
          <title>Bandcamp Icon & Link to Account</title>
          <path d="M33 4C16.4 4 3 17.4 3 34s13.4 30 30 30 30-13.4 30-30S49.6 4 33 4zm8.3 41.5c-.3.6-.6.8-1.2.8H11.5l.4-.8 13-24c.3-.6.6-.8 1-.8h29l-.4.8-13 24z"/>
        </svg>
      </a>
    </div>
  </div>
